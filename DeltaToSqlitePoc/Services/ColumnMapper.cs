...
public static class ColumnMapper
{
    ...
    public static Dictionary<string, string> GetColumnMappings(string tableName)
    {
        ...
        if (string.Equals(tableName, WarehouseSchema.DefaultTableName, StringComparison.OrdinalIgnoreCase))
        {
            ...
            {
                // Warehouse
                // { "<SourceColumn>", "WarehouseMasterId" },
                // { "<SourceColumn>", "Warehouse" },
                // { "<SourceColumn>", "Name" },
                // { "<SourceColumn>", "Site" },
                // { "<SourceColumn>", "Type" },
                // { "<SourceColumn>", "QuarantineWarehouse" },
                // { "<SourceColumn>", "TransitWarehouse" },
                // { "<SourceColumn>", "GoodsInTransitWarehouse" },
                // { "<SourceColumn>", "UnderDeliveryWarehouse" },
                // { "<SourceColumn>", "VendorAccount" },
                // { "<SourceColumn>", "DefaultReceiptLocation" },
                // { "<SourceColumn>", "DefaultIssueLocation" },
                // { "<SourceColumn>", "DefaultProductionFinishedGood" },
                // { "<SourceColumn>", "AddressNameDescription" },
                // { "<SourceColumn>", "Address" },
