...
public static class VendorSchema
{
    ...
    //public const string DefaultDeltaPath = "deltalake/mserp_mk_wbvendormaster";
    //public const string DefaultDeltaPath = "mserp_mk_wbvendormaster";
    public const string DefaultTableName = "Vendors"; // Master";
